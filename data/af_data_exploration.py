...
root_dir = (r'C:\Users\DELL\Desktop\rnn-based-af-detection-master\data\patient_data_100_beat_window_99_beat_overlap\train')
folder_path = root_dir
patients = [f for f in os.listdir(folder_path) if f.endswith('.csv')]


frames = [pd.read_csv(os.path.join(folder_path, f),header=None) for f in patients]
...
for patient in frames:
    ...
    plt.savefig('log/{0}.png'.format(patients[i]))
    i = i + 1
