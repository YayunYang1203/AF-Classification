...
# get the data
#
data = pd.read_csv('D:/rnn-based-af-detection-master/data/patient_data_100_beat_window_99_beat_overlap/test/08405_label_100_data.csv', engine = 'python')
print(data)
quit()
np.savez('D:/rnn-based-af-detection-master/data/patient_data_100_beat_window_99_beat_overlap/training_data', data)

# load the npz file
data_path = 'D:/rnn-based-af-detection-master/data/patient_data_100_beat_window_99_beat_overlap/training_data.npz'
